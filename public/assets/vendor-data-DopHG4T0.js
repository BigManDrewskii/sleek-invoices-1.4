import { r as _, j as Ot, R as ar } from "./vendor-react-BuVtq312.js";
var ue = class {
    constructor() {
  ...
  const n = $e(),
    ...
    x = () => {
      ...
      Promise.resolve(d)
        ...
        .catch(C => {
          if (i()) return;
          const E = e.retry ?? (oe ? 0 : 3),
            J = e.retryDelay ?? Or,
            X = typeof J == "function" ? J(r, C) : J,
            g =
              E === !0 ||
              (typeof E == "number" && r < E) ||
              (typeof E == "function" && E(r, C));
          if (t || !g) {
            p(C);
            return;
          }
...
var jt = class {
    ...
    updateGcTime(e) {
      this.gcTime = Math.max(this.gcTime || 0, e ?? (oe ? 1 / 0 : 300 * 1e3));
    }
    clearGcTimeout() {
  ...
  Pr = class extends jt {
    ...
    isStatic() {
      return this.getObserversCount() > 0
        ? this.observers.some(e => ee(e.options.staleTime, this) === "static")
        : !1;
    }
    isStale() {
      return this.getObserversCount() > 0
...
function Ct(e, t) {
  return {
    fetchFailureCount: 0,
    fetchFailureReason: null,
    fetchStatus: St(t.networkMode) ? "fetching" : "paused",
...
var ve = class extends ue {
  ...
  onSubscribe() {
    this.listeners.size === 1 &&
      ...
      ct(this.#e, this.options) ? this.#p() : this.updateResult(),
      this.#g());
  }
  onUnsubscribe() {
  ...
  shouldFetchOnReconnect() {
    return We(this.#e, this.options, this.options.refetchOnReconnect);
  }
  ...
  setOptions(e) {
    ...
    (s && lt(this.#e, r, this.options, t) && this.#p(),
      this.updateResult(),
      s &&
        (this.#e !== r ||
          z(this.options.enabled, this.#e) !== z(t.enabled, this.#e) ||
          ee(this.options.staleTime, this.#e) !== ee(t.staleTime, this.#e)) &&
        this.#v());
    const n = this.#m();
    s &&
      (this.#e !== r ||
  ...
  #v() {
    this.#O();
    const e = ee(this.options.staleTime, this.#e);
    if (oe || this.#s.isStale || !Le(e)) return;
    const r = Pt(this.#s.dataUpdatedAt, e) + 1;
  ...
  #P() {
    this.#l && (ie.clearInterval(this.#l), (this.#l = void 0));
  }
  createResult(e, t) {
    const r = this.#e,
      s = this.options,
    ...
    if (t._optimisticResults) {
      const m = this.hasListeners(),
        P = !m && ct(e, t),
        O = m && lt(e, r, t, s);
      ((P || O) && (l = { ...l, ...Ct(c.data, e.options) }),
        t._optimisticResults === "isRestoring" && (l.fetchStatus = "idle"));
    }
    let { error: v, errorUpdatedAt: x, status: d } = l;
    p = l.data;
    let j = !1;
    ...
    if (t.select && p !== void 0 && !j)
      if (n && p === i?.data && t.select === this.#d) p = this.#f;
      else
        try {
          ((this.#d = t.select),
            (p = t.select(p)),
    ...
    this.#o && ((v = this.#o), (p = this.#f), (x = Date.now()), (d = "error"));
    const C = l.fetchStatus === "fetching",
      E = d === "pending",
      J = d === "error",
      X = E && C,
      g = p !== void 0,
    ...
    if (this.options.experimental_prefetchInRender) {
      const m = w => {
          f.status === "error"
            ? w.reject(f.error)
            : f.data !== void 0 && w.resolve(f.data);
        },
        P = () => {
          const w = (this.#a = f.promise = $e());
          m(w);
        },
        O = this.#a;
      switch (O.status) {
        case "pending":
          e.queryHash === r.queryHash && m(O);
          break;
        case "fulfilled":
          (f.status === "error" || f.data !== O.value) && P();
          break;
        case "rejected":
          (f.status !== "error" || f.error !== O.reason) && P();
          break;
      }
    }
    return f;
  ...
  updateResult() {
    ...
    if (
      ((this.#n = this.#e.state),
      (this.#i = this.options),
      this.#n.data !== void 0 && (this.#h = this.#e),
      ye(t, e))
    )
      return;
    this.#s = t;
    const r = () => {
      ...
      if (n === "all" || (!n && !this.#y.size)) return !0;
      const i = new Set(n ?? this.#y);
      return (
...
function ct(e, t) {
  return xr(e, t) || (e.state.data !== void 0 && We(e, t, t.refetchOnMount));
}
function We(e, t, r) {
  if (z(t.enabled, e) !== !1 && ee(t.staleTime, e) !== "static") {
...
function Xe(e, t) {
  return z(t.enabled, e) !== !1 && e.isStaleByTime(ee(t.staleTime, e));
}
function wr(e, t) {
    ...
    onFetch: (t, r) => {
      ...
      const c = async () => {
        ...
        const h = x => {
          ...
          p = xt(t.options, t.fetchOptions),
          v = async (x, d, j) => {
            if (l) return Promise.reject();
            if (d == null && x.pages.length) return Promise.resolve(x);
            const E = (() => {
                const b = {
                  client: t.client,
                  queryKey: t.queryKey,
            ...
            return {
              pages: g(x.pages, J, X),
              pageParams: g(x.pageParams, d, X),
            };
          };
        if (n && i.length) {
          const x = n === "backward",
            d = x ? Rt : Ge,
            j = { pages: i, pageParams: o },
            C = d(s, j);
          a = await v(j, C, x);
        } else {
          const x = e ?? i.length;
          do {
            const d = u === 0 ? (o[0] ?? s.initialPageParam) : Ge(s, a);
            if (u > 0 && d == null) break;
            ((a = await v(a, d)), u++);
          } while (u < x);
        }
...
function _r(e, t) {
  return !t || !e.getPreviousPageParam ? !1 : Rt(e, t) != null;
}
var Qt = class extends ve {
    ...
    setOptions(e) {
      super.setOptions({ ...e, behavior: Ce() });
    }
    getOptimisticResult(e) {
      return ((e.behavior = Ce()), super.getOptimisticResult(e));
    }
    fetchNextPage(e) {
      return this.fetch({
        ...e,
    ...
    createResult(e, t) {
      ...
      return {
        ...
        hasNextPage: Sr(t, r.data),
        hasPreviousPage: _r(t, r.data),
...
var Cr = class extends ue {
  ...
  find(e) {
    const t = { exact: !0, ...e };
    return this.getAll().find(r => it(t, r));
  }
  findAll(e = {}) {
  ...
  resumePausedMutations() {
    ...
    return k.batch(() => Promise.all(e.map(t => t.continue().catch($))));
  }
};
function Oe(e) {
...
var Rr = class extends ue {
  ...
  setOptions(e) {
    ...
    ((this.options = this.#t.defaultMutationOptions(e)),
      ...
      te(t.mutationKey) !== te(this.options.mutationKey)
        ? this.reset()
...
var Er = class extends ue {
    ...
    getOptimisticResult(e, t) {
      const r = this.#c(e),
        s = r.map(n => n.observer.getOptimisticResult(n.defaultedQueryOptions));
      return [s, n => this.#h(n ?? s, t), () => this.#f(s, r)];
    }
    #f(e, t) {
      return t.map((r, s) => {
        const n = e[s];
    ...
    #h(e, t) {
      return t
        ? ((!this.#i || this.#e !== this.#o || t !== this.#a) &&
            ((this.#a = t), (this.#o = this.#e), (this.#i = Ye(this.#i, t(e)))),
          this.#i)
        : e;
    }
    #c(e) {
      const t = new Map(this.#n.map(s => [s.options.queryHash, s])),
        r = [];
      return (
        e.forEach(s => {
    ...
    #l(e, t) {
      ...
      r !== -1 && ((this.#e = Qr(this.#e, r, t)), this.#u());
    }
    #u() {
      if (this.hasListeners()) {
        const e = this.#i,
          t = this.#f(this.#e, this.#d),
          r = this.#h(t, this.#s?.combine);
        e !== r &&
          k.batch(() => {
  ...
  Mr = class extends ue {
    ...
    find(e) {
      const t = { exact: !0, ...e };
      return this.getAll().find(r => st(t, r));
    }
    findAll(e = {}) {
      const t = this.getAll();
      return Object.keys(e).length > 0 ? t.filter(r => st(e, r)) : t;
    }
    notify(e) {
      k.batch(() => {
        this.listeners.forEach(t => {
  ...
  fs = class {
    ...
    #o;
    constructor(e = {}) {
      ((this.#t = e.queryCache || new Mr()),
        (this.#e = e.mutationCache || new Cr()),
    ...
    mount() {
      (this.#i++,
        this.#i === 1 &&
          ((this.#a = Ze.subscribe(async e => {
            e && (await this.resumePausedMutations(), this.#t.onFocus());
          })),
          (this.#o = je.subscribe(async e => {
    ...
    ensureQueryData(e) {
      ...
      return s === void 0
        ? this.fetchQuery(e)
        : (e.revalidateIfStale &&
            r.isStaleByTime(ee(t.staleTime, r)) &&
    ...
    cancelQueries(e, t = {}) {
      ...
      return Promise.all(s).then($).catch($);
    }
    ...
    fetchQuery(e) {
      ...
      return r.isStaleByTime(ee(t.staleTime, r))
        ? r.fetch(t)
    ...
    fetchInfiniteQuery(e) {
      return ((e.behavior = Ce(e.pages)), this.fetchQuery(e));
    }
    prefetchInfiniteQuery(e) {
      return this.fetchInfiniteQuery(e).then($).catch($);
    }
    ensureInfiniteQueryData(e) {
      return ((e.behavior = Ce(e.pages)), this.ensureQueryData(e));
    }
    resumePausedMutations() {
      return je.isOnline()
    ...
    setQueryDefaults(e, t) {
      this.#s.set(te(e), { queryKey: e, defaultOptions: t });
    }
    getQueryDefaults(e) {
    ...
    setMutationDefaults(e, t) {
      this.#n.set(te(e), { mutationKey: e, defaultOptions: t });
    }
  ...
  Mt = _.createContext(void 0),
  me = e => {
    const t = _.useContext(Mt);
    if (e) return e;
    if (!t)
  ...
  hs = ({ client: e, children: t }) => (
    ...
    Ot.jsx(Mt.Provider, { value: e, children: t })
  ),
  It = _.createContext(!1),
  qt = () => _.useContext(It);
It.Provider;
function Ir() {
  let e = !1;
...
var qr = _.createContext(Ir()),
  ...
  At = ({
    ...
    !e.isFetching &&
    s &&
    ((n && e.data === void 0) || wt(r, [e.error, s])),
  et = (e, t) => t.state.data === void 0,
  kt = e => {
    if (e.suspense) {
  ...
  Ut = (e, t) => e.isLoading && e.isFetching && !t,
  ze = (e, t) => e?.suspense && t.isPending,
  Re = (e, t, r) =>
    t.fetchOptimistic(e).catch(() => {
      r.clearReset();
    });
function Lt({ queries: e, ...t }, r) {
  const s = me(r),
    n = qt(),
    i = Dt(),
    o = _.useMemo(
      () =>
        e.map(d => {
          const j = s.defaultQueryOptions(d);
          return ((j._optimisticResults = n ? "isRestoring" : "optimistic"), j);
        }),
      [e, s, n]
    );
  (o.forEach(d => {
    ...
    Ft(i));
  const [a] = _.useState(() => new Er(s, o, t)),
    [u, c, l] = a.getOptimisticResult(o, t.combine),
    h = !n && t.subscribed !== !1;
  (_.useSyncExternalStore(
    _.useCallback(d => (h ? a.subscribe(k.batchCalls(d)) : $), [a, h]),
    () => a.getCurrentResult(),
    () => a.getCurrentResult()
  ),
    _.useEffect(() => {
  ...
  const v = u.some((d, j) => ze(o[j], d))
    ? u.flatMap((d, j) => {
        const C = o[j];
        if (C) {
          const E = new ve(s, C);
          if (ze(C, d)) return Re(C, E, i);
          Ut(d, n) && Re(C, E, i);
        }
        return [];
      })
  ...
  const x = u.find((d, j) => {
    ...
    return (
      ...
      At({
        ...
        query: s.getQueryCache().get(C.queryHash),
        suspense: C.suspense,
      })
    );
  });
...
function Ee(e, t, r) {
  ...
  if (
    (_.useSyncExternalStore(
      _.useCallback(
        h => {
          const p = l ? u.subscribe(k.batchCalls(h)) : $;
  ...
  return (
    ...
    o.experimental_prefetchInRender &&
      !oe &&
      Ut(c, s) &&
      (a ? Re(o, u, n) : i.getQueryCache().get(o.queryHash)?.promise)
        ?.catch($)
        .finally(() => {
          u.updateResult();
        }),
...
function Fr(e, t) {
  return Ee({ ...e, enabled: !0, suspense: !0, throwOnError: et }, Qt, t);
}
function Ar(e, t) {
  return Lt(
    {
...
function Lr(e, t) {
  const r = me(t),
    [s] = _.useState(() => new Rr(r, e));
  _.useEffect(() => {
    s.setOptions(e);
  }, [s, e]);
  const n = _.useSyncExternalStore(
      _.useCallback(o => s.subscribe(k.batchCalls(o)), [s]),
      () => s.getCurrentResult(),
      () => s.getCurrentResult()
    ),
    i = _.useCallback(
  ...
  if (n.error && wt(s.options.throwOnError, [n.error])) throw n.error;
...
const $r = typeof Symbol == "function" && !!Symbol.asyncIterator;
function Kt(e) {
  return $r && ae(e) && Symbol.asyncIterator in e;
}
var Hr = Object.create,
  ...
  Br = (e, t, r, s) => {
    if ((t && typeof t == "object") || typeof t == "function")
      for (var n = $t(t), i = 0, o = n.length, a; i < o; i++)
        ((a = n[i]),
          !zr.call(e, a) &&
            a !== r &&
            Nt(e, a, {
              get: (u => t[u]).bind(null, a),
              enumerable: !(s = Wr(t, a)) || s.enumerable,
            }));
    return e;
  },
  Me = (e, t, r) => (
    (r = e != null ? Hr(Gr(e)) : {}),
    Br(Nt(r, "default", { value: e, enumerable: !0 }), e)
  );
const Ht = () => {},
  ht = e => {
...
function Yr(e, t) {
  if ("error" in e) {
    ...
    return {
      ok: !1,
      error: (0, Pe.default)((0, Pe.default)({}, e), {}, { error: s }),
    };
  }
  return {
    ok: !0,
    result: (0, Pe.default)(
      (0, Pe.default)({}, e.result),
...
function Zr(e, t) {
  ...
  if (!r.ok && (!ae(r.error.error) || typeof r.error.error.code != "number"))
    throw new Fe();
  if (r.ok && !ae(r.result)) throw new Fe();
  return r;
}
Me(rt());
function qe(e) {
...
var tn = Object.create,
  ...
  re = (e, t) =>
    function () {
      return (
        t || (0, e[Jt(e)[0]])((t = { exports: {} }).exports, t),
        t.exports
      );
    },
  on = (e, t, r, s) => {
    if ((t && typeof t == "object") || typeof t == "function")
      for (var n = Jt(t), i = 0, o = n.length, a; i < o; i++)
        ((a = n[i]),
          !sn.call(e, a) &&
            a !== r &&
            Bt(e, a, {
              get: (u => t[u]).bind(null, a),
              enumerable: !(s = rn(t, a)) || s.enumerable,
            }));
    return e;
  },
  ce = (e, t, r) => (
    ...
    on(
      t || !e || !e.__esModule
        ? Bt(r, "default", { value: e, enumerable: !0 })
        : r,
      e
    )
  ),
  ...
  hn = ce(un(), 1),
  dt = ce(ge(), 1);
const dn = ["cursor", "direction"];
function V(e, t, r) {
  const s = e.flatMap(n => n.split("."));
  if (!t && (!r || r === "any")) return s.length ? [s] : [];
  if (r === "infinite" && ae(t) && ("direction" in t || "cursor" in t)) {
  ...
  return [
    s,
    (0, dt.default)(
      (0, dt.default)({}, typeof t < "u" && t !== W && { input: t }),
      r && r !== "any" && { type: r }
    ),
  ];
}
function Se(e) {
  return V(e, void 0, "any");
}
var pn = Object.create,
  ...
  Y = (e, t) =>
    function () {
      return (
        t || (0, e[Zt(e)[0]])((t = { exports: {} }).exports, t),
        t.exports
      );
    },
  bn = (e, t, r, s) => {
    if ((t && typeof t == "object") || typeof t == "function")
      for (var n = Zt(t), i = 0, o = n.length, a; i < o; i++)
        ((a = n[i]),
          !mn.call(e, a) &&
            a !== r &&
            Yt(e, a, {
  ...
  U = (e, t, r) => (
    (r = e != null ? pn(vn(e)) : {}),
    bn(Yt(r, "default", { value: e, enumerable: !0 }), e)
  ),
  Xt = Y({
    "../../node_modules/.pnpm/@oxc-project+runtime@0.72.2/node_modules/@oxc-project/runtime/src/helpers/typeof.js"(
      e,
...
function jn(e, t) {
  return typeof e == "string"
    ? e
    : ae(e) && typeof e.message == "string"
      ? e.message
      : t;
}
var Qe = class _e extends Error {
  constructor(t, r) {
    var s, n;
    const i = r?.cause;
    (super(t, { cause: i }),
      (0, xe.default)(this, "cause", void 0),
      (0, xe.default)(this, "shape", void 0),
      (0, xe.default)(this, "data", void 0),
      (0, xe.default)(this, "meta", void 0),
      (this.meta = r?.meta),
      (this.cause = i),
      (this.shape =
  ...
  static from(t, r = {}) {
    ...
    return Sn(s)
      ...
      : _n(s)
        ? new _e(
            s.error.message,
            (0, fe.default)((0, fe.default)({}, r), {}, { result: s })
          )
        : new _e(
            jn(s, "Unknown error"),
            (0, fe.default)((0, fe.default)({}, r), {}, { cause: s })
          );
  }
};
function Cn(e) {
...
const pt = e => typeof e == "function";
function Rn(e) {
  if (e) return e;
  if (typeof window < "u" && pt(window.fetch)) return window.fetch;
  if (typeof globalThis < "u" && pt(globalThis.fetch)) return globalThis.fetch;
...
const Mn = { query: "GET", mutation: "POST", subscription: "PATCH" };
function er(e) {
  return "input" in e
    ? e.transformer.input.serialize(e.input)
    : En(e.inputs.map(t => e.transformer.input.serialize(t)));
}
const tr = e => {
    const t = e.url.split("?");
  ...
  qn = e =>
    An(
      (0, de.default)(
        (0, de.default)({}, e),
        {},
        { contentTypeHeader: "application/json", getUrl: tr, getBody: In }
      )
    );
...
async function Fn(e) {
  ...
  const r = e.getUrl(e),
    s = e.getBody(e),
    n = (t = e.methodOverride) !== null && t !== void 0 ? t : Mn[e.type],
    i = await (async () => {
      const a = await e.headers();
      return Symbol.iterator in a ? Object.fromEntries(a) : a;
    })(),
    o = (0, de.default)(
      (0, de.default)(
        (0, de.default)(
          {},
          e.contentTypeHeader && n !== "GET"
  ...
  return Rn(e.fetch)(r, { method: n, signal: e.signal, body: s, headers: o });
}
async function An(e) {
  const t = {},
    r = await Fn(e);
...
function vt(e) {
          ...
          await Promise.all(
            h.map(async (v, x) => {
              ...
              try {
                ...
                (j = d.resolve) === null || j === void 0 || j.call(d, E);
              } catch (E) {
                var C;
                (C = d.reject) === null || C === void 0 || C.call(d, E);
              }
  ...
  function o(a) {
    var u;
    const c = { aborted: !1, key: a, batch: null, resolve: yt, reject: yt },
      l = new Promise((h, p) => {
        var v;
        ((c.reject = p),
          (c.resolve = h),
...
function ds(e) {
  ...
  return () => {
    const o = l => ({
        ...
        async fetch(h) {
          const p = h.map(E => E.path).join(","),
            v = h.map(E => E.input),
            x = kn(...h.map(E => E.signal)),
            d = await qn(
              (0, we.default)(
                (0, we.default)({}, s),
                {},
    ...
    return ({ op: l }) =>
      qe(h => {
        /* istanbul ignore if -- @preserve */ if (l.type === "subscription")
          throw new Error(
        ...
        return (
          v
            .then(d => {
              x = d;
              const j = Zr(d.json, s.transformer.output);
              if (!j.ok) {
                h.error(Qe.from(j.error, { meta: d.meta }));
                return;
              }
              (h.next({ context: d.meta, result: j.result }), h.complete());
            })
            .catch(d => {
              h.error(Qe.from(d, { meta: x?.meta }));
            }),
          () => {}
        );
      });
...
U(B());
const rr = (e, ...t) => (typeof e == "function" ? e(...t) : e);
U(le());
function Un() {
  let e, t;
  return {
...
async function Ln(e) {
  const t = await rr(e.url);
  if (!e.connectionParams) return t;
  const s = `${t.includes("?") ? "&" : "?"}connectionParams=1`;
  return t + s;
}
async function Kn(e) {
  const t = { method: "connectionParams", data: await rr(e) };
  return JSON.stringify(t);
}
U(le());
var se = U(le());
function Nn(e) {
  const { promise: t, resolve: r, reject: s } = Un();
  return (
...
var Hn = class Be {
  constructor(t) {
    var r;
    if (
      ((0, se.default)(this, "id", ++Be.connectCount),
      (0, se.default)(this, "WebSocketPonyfill", void 0),
      (0, se.default)(this, "urlOptions", void 0),
      (0, se.default)(this, "keepAliveOpts", void 0),
      (0, se.default)(this, "wsObservable", xn(null)),
      (0, se.default)(this, "openPromise", null),
  ...
  async open() {
    ...
    t.id = ++Be.connectCount;
    const r = Ln(t.urlOptions).then(s => new t.WebSocketPonyfill(s));
    t.openPromise = r.then(async s => {
      ((t.ws = s),
        ...
        t.urlOptions.connectionParams &&
          s.send(await Kn(t.urlOptions.connectionParams)));
    });
    try {
      await t.openPromise;
    } finally {
...
(0, se.default)(Hn, "connectCount", 0);
U(le());
U(B());
var Ae = U(le()),
  mt = U(B()),
  De = class {
    constructor(e) {
      ((0, Ae.default)(this, "links", void 0),
        (0, Ae.default)(this, "runtime", void 0),
        (0, Ae.default)(this, "requestId", void 0),
        (this.requestId = 0),
        (this.runtime = {}),
...
const nr = Symbol.for("trpc_untypedClient"),
  Wn = { query: "query", mutate: "mutation", subscribe: "subscription" },
  Gn = e => Wn[e];
function sr(e) {
  const t = Ie(({ path: r, args: s }) => {
    const n = [...r],
      i = Gn(n.pop()),
      o = n.join(".");
    return e[i](o, ...s);
  });
  return tt(r => (r === nr ? e : t[r]));
}
function zn(e) {
  const t = new De(e);
  return sr(t);
      ...
      function n(i) {
        ...
        function u(l, h) {
          try {
            var p = i[l](h),
              v = p.value,
              x = v instanceof r;
            Promise.resolve(x ? v.v : v).then(
              function (d) {
                if (x) {
                  var j = l === "return" ? "return" : "next";
                  if (!v.k || d.done) return u(j, d);
                  d = i[j](d).value;
                }
        ...
        ((this._invoke = function (l, h) {
          return new Promise(function (p, v) {
            var x = { key: l, arg: h, resolve: p, reject: v, next: null };
            a ? (a = a.next = x) : ((o = a = x), u(l, h));
          });
        }),
...
var ke;
const Xn = ["client", "ssrContext", "ssrState", "abortOnUnmount"],
  es =
    (ke = _.createContext) === null || ke === void 0
      ? void 0
      : ke.call(ar, null),
  ts = e => {
    switch (e) {
...
function rs(e) {
  return Ie(t => {
    ...
    return {
      ...
      setMutationDefaults: () => e.setMutationDefaults(Se(r), i),
      getMutationDefaults: () => e.getMutationDefaults(Se(r)),
      isMutating: () => e.isMutating({ mutationKey: Se(r) }),
    }[s]();
  });
}
function ns(e) {
  ...
  return tt(s => {
    const n = s;
    return n === "client" ? t : Xn.includes(n) ? e[n] : r[s];
  });
}
var ss = ce(ge(), 1);
function bt(e) {
  const t = e instanceof De ? e : nt(e);
  return Ie(r => {
    const s = r.path,
      n = s.join("."),
      [i, o] = r.args;
    return (0, ss.default)(
      { queryKey: V(s, i, "query"), queryFn: () => t.query(n, i, o?.trpc) },
      o
    );
  });
}
...
function H(e, t, r) {
  ...
  if (r) {
    ...
    i = (0, Ue.default)(
      (0, Ue.default)(
        (0, Ue.default)({}, (o = i) !== null && o !== void 0 ? o : {}),
...
function us(e) {
  ...
  const s = (t = void 0) !== null && t !== void 0 ? t : g => g.originalFn(),
    n = (r = void 0) !== null && r !== void 0 ? r : es,
    i = zn,
    o = g => {
      var b;
      const { abortOnUnmount: f = !1, queryClient: m, ssrContext: P } = g,
        [O, w] = _.useState((b = g.ssrState) !== null && b !== void 0 ? b : !1),
        S = g.client instanceof De ? g.client : nt(g.client),
        I = _.useMemo(() => as({ client: S, queryClient: m }), [S, m]),
        Q = _.useMemo(
          () =>
            (0, y.default)(
              {
      ...
      return (
        ...
        Ot.jsx(n.Provider, { value: Q, children: g.children })
      );
    };
  function a() {
    const g = _.useContext(n);
    if (!g)
      throw new Error(
  ...
  function u(g, b) {
    var f;
    const { queryClient: m, ssrState: P } = a();
    return P &&
      P !== "mounted" &&
  ...
  function c(g, b, f) {
    ...
    const I = a(),
      ...
      K = V(g, b, "query"),
      Z = F.getQueryDefaults(K),
      L = b === W;
    typeof window > "u" &&
      M === "prepass" &&
      (f == null || (m = f.trpc) === null || m === void 0 ? void 0 : m.ssr) !==
        !1 &&
      ((P = f?.enabled) !== null && P !== void 0 ? P : Z?.enabled) !== !1 &&
      !L &&
      !F.getQueryCache().find({ queryKey: K }) &&
      A(K, f);
    const G = u(K, (0, y.default)((0, y.default)({}, Z), f)),
      T =
        (O =
          (w =
        ...
        (0, y.default)(
          ...
          {},
          {
            ...
            queryFn: L
              ? b
              : async N => {
                  const ne = (0, y.default)(
                      (0, y.default)({}, G),
                      {},
                      {
                        trpc: (0, y.default)(
                          (0, y.default)({}, G?.trpc),
                          T ? { signal: N.signal } : { signal: null }
                        ),
                      }
                    ),
                    Te = await D.query(...H(K, ne));
                  return Kt(Te) ? or(Te, F, K) : Te;
                },
          }
        ),
        F
        ...
        (m =
          (P =
            f == null || (O = f.trpc) === null || O === void 0
              ? void 0
              : O.abortOnUnmount) !== null && P !== void 0
            ? P
  ...
  function p(g, b) {
    const { client: f, queryClient: m } = a(),
      P = Se(g),
      O = m.defaultMutationOptions(m.getMutationDefaults(P)),
      w = Lr(
        (0, y.default)(
          (0, y.default)({}, b),
          {},
          {
            mutationKey: P,
            mutationFn: S => f.mutation(...H([g, { input: S }], b)),
            onSuccess(...S) {
              var I, Q;
              return s({
                originalFn: () => {
                  ...
                  return (M =
                    b == null || (F = b.onSuccess) === null || F === void 0
                      ? void 0
                      : F.call(b, ...S)) !== null && M !== void 0
                    ? M
                    : O == null || (A = O.onSuccess) === null || A === void 0
                      ? void 0
                      : A.call(O, ...S);
                },
                queryClient: m,
                meta:
                  (I = (Q = b?.meta) !== null && Q !== void 0 ? Q : O?.meta) !==
                    null && I !== void 0
                    ? I
                    : {},
              });
    ...
    return ((w.trpc = he({ path: g })), w);
  }
  const v = { data: void 0, error: null, status: "idle" },
    x = { data: void 0, error: null, status: "connecting" };
  /* istanbul ignore next -- @preserve */ function d(g, b, f) {
    var m;
    const P = (m = f?.enabled) !== null && m !== void 0 ? m : b !== W,
      O = te(V(g, b, "any")),
      { client: w } = a(),
      S = _.useRef(f);
    _.useEffect(() => {
    ...
    const [I] = _.useState(new Set([])),
      ...
      F = _.useCallback(() => {
        var L;
        if (((L = D.current) === null || L === void 0 || L.unsubscribe(), !P)) {
          M(() => (0, y.default)((0, y.default)({}, v), {}, { reset: F }));
          return;
        }
        M(() => (0, y.default)((0, y.default)({}, x), {}, { reset: F }));
        const G = w.subscription(g.join("."), b ?? void 0, {
          onStarted: () => {
            var T, q;
            ((T = (q = S.current).onStarted) === null ||
              T === void 0 ||
              T.call(q),
              M(N =>
                (0, y.default)(
            ...
            ((q = (N = S.current).onData) === null ||
              ...
              M(ne =>
                (0, y.default)(
                  (0, y.default)({}, ne),
                  {},
                  { status: "pending", data: T, error: null }
                )
              ));
          },
          onError: T => {
            var q, N;
            ((q = (N = S.current).onError) === null ||
              q === void 0 ||
              q.call(N, T),
              M(ne =>
                (0, y.default)(
              ...
              switch (T.state) {
                case "idle":
                  return (0, y.default)(
                    (0, y.default)({}, q),
                    {},
                    { status: T.state, error: null, data: void 0 }
                  );
                case "connecting":
                  return (0, y.default)(
                    (0, y.default)({}, q),
                    {},
                    { error: T.error, status: T.state }
                  );
                case "pending":
                  return q;
              }
    ...
    _.useEffect(
      () => (
        ...
        () => {
          var L;
          (L = D.current) === null || L === void 0 || L.unsubscribe();
        }
      ),
      [F]
    );
    const A = _.useRef(
        P
          ? (0, y.default)((0, y.default)({}, x), {}, { reset: F })
          : (0, y.default)((0, y.default)({}, v), {}, { reset: F })
      ),
      [K, Z] = _.useState(gt(A.current, Q));
    return K;
  }
  function j(g, b, f) {
    var m, P, O, w, S;
    const {
      ...
      A = V(g, b, "infinite"),
      K = M.getQueryDefaults(A),
      Z = b === W;
    typeof window > "u" &&
      Q === "prepass" &&
      (f == null || (m = f.trpc) === null || m === void 0 ? void 0 : m.ssr) !==
        !1 &&
      ((P = f?.enabled) !== null && P !== void 0 ? P : K?.enabled) !== !1 &&
      !Z &&
      !M.getQueryCache().find({ queryKey: A }) &&
      D(A, (0, y.default)((0, y.default)({}, K), f));
    const L = u(A, (0, y.default)((0, y.default)({}, K), f)),
      G =
        (O =
      ...
      T = Kr(
        (0, y.default)(
          ...
          {
            initialPageParam:
              (S = f.initialCursor) !== null && S !== void 0 ? S : null,
    ...
    return ((T.trpc = he({ path: g })), T);
  }
  function C(g, b, f) {
    var m, P, O;
    const w = a(),
      S = V(g, b, "infinite"),
      I = w.queryClient.getQueryDefaults(S),
      Q = b === W,
      D = u(S, (0, y.default)((0, y.default)({}, I), f)),
      M =
        (m =
          f == null || (P = f.trpc) === null || P === void 0
            ? void 0
            : P.abortOnUnmount) !== null && m !== void 0
          ? m
          : w.abortOnUnmount;
    Ur(
      (0, y.default)(
        ...
        {
          initialPageParam:
            (O = f.initialCursor) !== null && O !== void 0 ? O : null,
          queryKey: S,
          queryFn: Q
            ? b
            : F => {
  ...
  function E(g, b, f) {
    ...
    const w = a(),
      S = V(g, b, "infinite"),
      I = w.queryClient.getQueryDefaults(S),
      Q = u(S, (0, y.default)((0, y.default)({}, I), f)),
      D =
        (m =
          f == null || (P = f.trpc) === null || P === void 0
            ? void 0
  ...
  return {
    ...
    useSuspenseQuery: h,
    useQueries: (g, b) => {
      const { ssrState: f, queryClient: m, prefetchQuery: P, client: O } = a(),
        w = bt(O),
        S = g(w);
      if (typeof window > "u" && f === "prepass")
        for (const Q of S) {
          var I;
          const D = Q;
          ((I = D.trpc) === null || I === void 0 ? void 0 : I.ssr) !== !1 &&
            !m.getQueryCache().find({ queryKey: D.queryKey }) &&
            P(D.queryKey, D);
        }
      return Lt(
        {
        ...
        O = Ar(
          {
            queries: P.map(w =>
              (0, y.default)(
                (0, y.default)({}, w),
                {},
                { queryFn: w.queryFn, queryKey: w.queryKey }
              )
            ),
          },
          b
        );
      return [O.map(w => w.data), O];
    },
    useMutation: p,
    useSubscription: d,
    useInfiniteQuery: j,
    usePrefetchInfiniteQuery: C,
    useSuspenseInfiniteQuery: E,
  };
}
function cs(e) {
  const t = Zn(e);
...
export { fs as Q, Qe as T, hs as a, ps as c, ds as h };
