import { j as t } from "./vendor-react-BuVtq312.js";
import { c as i, B as l } from "./index-hzFfJlKH.js";
function x({
  icon: a,
  illustration: n,
  title: c,
  ...
  return t.jsxs("div", {
    "data-loc": "client/src/components/EmptyState.tsx:91",
    className: i(
    ...
    children: [
      t.jsx("div", {
        "data-loc": "client/src/components/EmptyState.tsx:99",
        className: "mb-6",
        children: n
          ? typeof n == "string"
            ? t.jsx("img", {
                "data-loc": "client/src/components/EmptyState.tsx:102",
                src: n,
                alt: "",
                loading: "lazy",
                className: i(e.illustration, "object-contain opacity-95"),
              })
            : t.jsx("div", {
                "data-loc": "client/src/components/EmptyState.tsx:109",
                className: e.illustration,
                children: n,
              })
          : a
            ? t.jsx("div", {
                "data-loc": "client/src/components/EmptyState.tsx:112",
                className: "rounded-full bg-muted p-4",
                children: t.jsx(a, {
                  "data-loc": "client/src/components/EmptyState.tsx:113",
                  className: i(e.icon, "text-muted-foreground"),
                }),
              })
            : t.jsx("div", {
                "data-loc": "client/src/components/EmptyState.tsx:117",
                className: i(
                  e.illustration,
                ...
                children: t.jsx("span", {
                  "data-loc": "client/src/components/EmptyState.tsx:124",
      ...
      t.jsx("h3", {
        "data-loc": "client/src/components/EmptyState.tsx:130",
        className: i("font-semibold text-foreground mb-2", e.title),
        children: c,
      }),
      t.jsx("p", {
        "data-loc": "client/src/components/EmptyState.tsx:133",
        className: i("text-muted-foreground max-w-sm mb-6", e.description),
        children: r,
      }),
      (s || o) &&
        t.jsxs("div", {
          "data-loc": "client/src/components/EmptyState.tsx:141",
          className: "flex items-center gap-3",
          children: [
            s &&
              t.jsxs(l, {
                "data-loc": "client/src/components/EmptyState.tsx:143",
                onClick: s.onClick,
                className: "gap-2",
                children: [
                  s.icon &&
                    t.jsx(s.icon, {
                      "data-loc": "client/src/components/EmptyState.tsx:144",
                      className: "h-4 w-4",
                    }),
                  s.label,
                ],
            ...
            o &&
              t.jsx(l, {
                "data-loc": "client/src/components/EmptyState.tsx:149",
                variant: "outline",
                onClick: o.onClick,
                children: o.label,
              }),
