import { j as r } from "./vendor-react-BuVtq312.js";
import {
  aj as e,
  ak as t,
  al as c,
...
import { c as s } from "./index-hzFfJlKH.js";
function p({ className: a, children: l, ...o }) {
  return r.jsxs(e, {
    ...
    children: [
      ...
      r.jsx(u, { "data-loc": "client/src/components/ui/scroll-area.tsx:23" }),
      r.jsx(c, { "data-loc": "client/src/components/ui/scroll-area.tsx:24" }),
    ],
  });
}
function u({ className: a, orientation: l = "vertical", ...o }) {
  return r.jsx(n, {
